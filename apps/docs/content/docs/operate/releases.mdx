...
For a Ready Complete or Control plane installation, `oore update` installs the signed release in place. Oore drains active work, creates a backup, restarts managed services, and verifies the result.
