...
In Oore's **OIDC** step, select **Google** under **Identity provider**, then enter:
...
### Google Cloud asks you to verify your identity

Complete Google's password or passkey check before you create credentials. Oore cannot bypass this provider security step.
