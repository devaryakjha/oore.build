 ...
 */
import type { LocalGitDirectoryEntry } from './local-git-directory-entry.ts'
import type { LocalGitPathSuggestion } from './local-git-path-suggestion.ts'

export interface BrowseLocalGitDirectoriesResponse {
  current_is_git_repository: boolean
  current_path: string
  directories: LocalGitDirectoryEntry[]
  /** @nullable */
  parent_path?: string | null
  suggestions: LocalGitPathSuggestion[]
}
