...
import type { RunnerIosProvisioningProfile } from './runner-ios-provisioning-profile.ts'

export interface RunnerIosSigningBundle {
  enabled: boolean
  ...
  p12_filename: string
  p12_password: string
  provisioning_profiles?: RunnerIosProvisioningProfile[]
  team_id: string
}
