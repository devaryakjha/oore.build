 ...
 */
import type { IosApiCredentialInput } from './ios-api-credential-input.ts'
import type { IosCertificateInput } from './ios-certificate-input.ts'
import type { IosProvisioningProfileInput } from './ios-provisioning-profile-input.ts'
import type { IosSigningMode } from './ios-signing-mode.ts'
...
export interface UpdatePipelineIosSigningRequest {
  ...
  enabled?: boolean
  mode: IosSigningMode
  provisioning_profiles?: IosProvisioningProfileInput[]
  /** @nullable */
  team_id?: string | null
}
