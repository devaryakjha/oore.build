...
export type ExternalAccessNetworkSource =
  (typeof ExternalAccessNetworkSource)[keyof typeof ExternalAccessNetworkSource]

export const ExternalAccessNetworkSource = {
  database: 'database',
