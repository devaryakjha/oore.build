...
fn api_router(state: AppState) -> Router {
    Router::new()
        ...
        .route("/builds/{id}/artifacts", get(routes::builds::list_build_artifacts))
        .route("/builds/{id}/artifacts/{artifact_id}", get(routes::builds::download_artifact))
        // Pipelines
...
fn admin_router(state: AppState) -> Router {
    ...
    Router::new()
        ...
        // Signing endpoints
        .route("/repositories/{id}/signing/status", get(routes::signing::get_signing_status))
        .route("/repositories/{id}/signing/ios/certificates", get(routes::signing::list_certificates))
        .route("/repositories/{id}/signing/ios/certificates", post(routes::signing::upload_certificate))
        .route("/repositories/{id}/signing/ios/certificates/{cert_id}", delete(routes::signing::delete_certificate))
        .route("/repositories/{id}/signing/ios/profiles", get(routes::signing::list_profiles))
        .route("/repositories/{id}/signing/ios/profiles", post(routes::signing::upload_profile))
        .route("/repositories/{id}/signing/ios/profiles/{profile_id}", delete(routes::signing::delete_profile))
        .route("/repositories/{id}/signing/ios/api-keys", get(routes::signing::list_api_keys))
        .route("/repositories/{id}/signing/ios/api-keys", post(routes::signing::upload_api_key))
        .route("/repositories/{id}/signing/ios/api-keys/{key_id}", delete(routes::signing::delete_api_key))
        .route("/repositories/{id}/signing/android/keystores", get(routes::signing::list_keystores))
        .route("/repositories/{id}/signing/android/keystores", post(routes::signing::upload_keystore))
        .route("/repositories/{id}/signing/android/keystores/{keystore_id}", delete(routes::signing::delete_keystore))
