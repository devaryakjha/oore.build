...
banner:
  content: |
    <strong>Alpha</strong> — Service management works. Builds, code signing, and artifacts are functional.
---
...
4. Writes launchd service definition
...
/Library/LaunchDaemons/build.oore.oored.plist   # Service definition
```
