...
banner:
  content: |
    <strong>Alpha</strong> — GitLab integration works. Webhooks trigger builds automatically.
---

import { Steps, Tabs, TabItem, Aside } from '@astrojs/starlight/components';

<Aside type="note">
GitLab integration is fully functional. Webhooks trigger builds, and you can sign and download artifacts. Distribution (publishing to app stores) is the next milestone.
</Aside>
