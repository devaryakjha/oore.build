...
banner:
  content: |
    <strong>Alpha</strong> — GitHub integration works. Webhooks trigger builds automatically.
---

import { Steps, Tabs, TabItem, Badge, Aside } from '@astrojs/starlight/components';

<Aside type="note">
GitHub integration is fully functional. Webhooks trigger builds, and you can sign and download artifacts. Distribution (publishing to app stores) is the next milestone.
</Aside>
